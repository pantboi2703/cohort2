...
// 18. Ask user 5 numbers. Count how many are positive. Use loop + conditions + counter.
let counter = 0;
for(let i=0; i<5; i++) {
...
console.log('The total number of positives are ${counter}');

// 19. ATM Simulator - Allow 3 withdrawls amount 3 times.
// Start with rupee 1000 balance. Ask withdrawl amount 3 times. If enough balance -> deduct, else -> "Insufficient balance".
...
//               OR 
let balance1 = 1000;
// let amount1 = +prompt("Enter the amount:");
let counter1 = 0;
let flag = false;
while(balance>0 && counter1 != 3) {
...
if(flag === true) {
  console.log("Insufficient Balamce.");
}
...
for(let i=1; i<10; i++) {
  if(i === 5) continue; // i=5 not print;
  console.log(i);
}

// functions in JS: aapka code jo turant nahi chalega tab chalega jab aap bologe ki ab chalo.
// aap us code ko kitni baar bhi chala sakte ho;
...
function doSomething() {
  console.log(arguments); // arguments is a variable 
  console.log(arguments[0]); // harsh
}
doSomething("harsh", 23, "harsh123@gmail.com");

// not call the function() before if you will not use function keyword.
a();
function a() {
  let i=0;
  console.log(i);
